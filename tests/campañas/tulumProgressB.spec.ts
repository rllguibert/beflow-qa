...
test.describe("Tulum Perfilador Testing",() => {
  let todoPage;   
    ...
    test.beforeEach(async ({ page }) => {
      ...
      await todoPage.goto('https://dbot-qa.opseeker.com/demo/tulumprogbar/index.html');
      });           



test.only('PerfiladorESP=1 test', async ({ page }) => {
  ...
  await page.locator('#input').fill('vacaciones');
